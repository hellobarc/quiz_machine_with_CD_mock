						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div>
									...
									<form action="{{route('admin.settings.quiz.update', $data->id)}}" method="POST">
										@csrf
										<div class="form-group">
											...
											<select class="form-control" name="exam_id">
											  ...
											  @foreach ($exams as $rows)
											  	<option value="{{$rows->id}}" {{$rows->id == $data->exam_id? 'selected': ''}}>{{$rows->title}}</option>
											  @endforeach
											</select>
										  </div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="marks" id="marks" value="{{$data->marks}}">
										</div>
										<div class="form-group">
											...
											<select class="form-control" name="status">
											 ...
											 @foreach ($quizzes as $item)
											 	<option value="{{$item->status}}"{{$item->status == $data->status? 'selected': ''}}>{{$item->status}}</option>
											 @endforeach
											</select>
										</div>
