								...
								<div class="row">
									<div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
                                        ...
                                        <div>
                                            ...
                                            <form action="{{route('admin.settings.mock.fill-blank.store-question')}}" method="POST">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="mb-2">Box Show</label>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$items->is_show}}</td>
                                                    <td>
                                                        <a href="{{route('admin.settings.mock.fill-blank.delete-question', $items->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
