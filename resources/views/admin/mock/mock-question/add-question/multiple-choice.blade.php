								...
								<div class="row">
									<div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 mx-auto">
                                        ...
                                        <div>
                                            ...
                                            <form action="{{route('admin.settings.mock.multiple-choice.store-question')}}" method="POST">
                                                @csrf
                                                ...
                                                @if($questionType == 'multiple-choice')
                                                    @foreach ($multipleChoice as $items)
                                                        <tr>
                                                            ...
                                                            <td>{{$items->marks}}</td>
                                                            <td>
                                                                <a href="{{route('admin.settings.mock.multiple-choice.delete-question', ['id'=>$items->id, 'questionType'=>$questionType])}}" class="btn btn-danger btn-sm">Delete</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @elseif($questionType == 'radio')
