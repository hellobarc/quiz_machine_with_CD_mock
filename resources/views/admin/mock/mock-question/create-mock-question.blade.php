								...
								<div>
									...
									<form action="{{route('admin.settings.mock.question.store')}}" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="mock_question_title" id="mock_question_title" aria-describedby="emailHelp" placeholder="Enter Mock Question Title">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea name="question_instruction" id="ck" cols="30" rows="5" class="form-control" placeholder="Question like this: text ##blank## text"></textarea>
										</div>
