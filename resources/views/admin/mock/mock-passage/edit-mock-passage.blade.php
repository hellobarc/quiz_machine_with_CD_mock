...
@section('title', 'Edit Mock Passage')
						...
						<div class="card">
										...
										<div class="flex-grow-1 px-30 flex-grow-1 bg-img dask-bg bg-none-md" style="background-position: right bottom; background-size: auto 100%; background-image: url({{asset('ed_admin/images/svg-icon/color-svg/custom-1.svg')}})">
											<div class="row">
												<div class="col-12 col-xl-7">
													<h3 class="fw-bolder">Edit Mock Passage</h3>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="card-body">
								...
								<div>
									...
									<form action="{{route('admin.settings.mock.passage.update', $data->id)}}" method="POST" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-group">
											...
											<textarea name="passage" id="ck" cols="30" rows="8" class="form-control" placeholder="Question like this: text ##blank## text">{{$data->passage}}</textarea>
										</div>
										{{-- <div class="form-group">
											<label for="name" class="mb-2">Previous passage image</label><br>
											<img src="{{ asset('image/uploads/mock/passage/'.$data->image) }}" alt="" width="100">
										  </div>
										<div class="form-group">
											<label for="name" class="mb-2">Upload New passage image</label>
